...
def goodFeaturesToTrack_Demo(val):
    ...
    for i in range(corners.shape[0]):
        cv.circle(copy, (corners[i,0,0], corners[i,0,1]), radius, (rng.randint(256,256), rng.randint(256,256), rng.randint(256,256)), cv.FILLED)
    # Show what you got
...
cv.namedWindow(source_window)
maxCorners = 80 # initial threshold
